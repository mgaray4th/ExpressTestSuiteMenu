...
public class XPTestMenuFrame extends JFrame implements ActionListener {
	...
	private JPanel JPanelMain, panelInbounds, panelRuleTriggers,panelCSP42,panelEnvironments;
	...
	private JCheckBox chckbxInbBonusFile,chckbxBonusRules,chckbxAllInbounds,chckbxAllRuleTrgr,
		chckbxApiRules,chckbxEngRule,chckbxAllCSP42,chckbxLoginpage42;
	...
	public XPTestMenuFrame() {
		...
		setBounds(100, 100, 419, 634);
		JPanelMain = new JPanel();
		JPanelMain.setBackground(Color.WHITE);
		JPanelMain.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null, null));
		setContentPane(JPanelMain);
		JPanelMain.setLayout(null);

		panelInbounds = new JPanel();
		panelInbounds.setBackground(Color.WHITE);
		panelInbounds.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Inbound Files.", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		chckbxInbCardDisassociation.setFont(new Font("Tahoma", Font.ITALIC, 11));
		...
		panelCSP42.setBorder(new TitledBorder(null, "CSPortal v4.2", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	public String GenerateSentence() throws Exception {
		...
		return "mvn test -DselectedTests=" + tests + " -Dbrowser=" + browsertype
		+ " -Dgroups=" + groups	+ " -Denvironment=" + env;
	}
}
